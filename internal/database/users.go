...
type User struct {
	...
	Password string `json:"_"` // password will be hashed, so we don't want to expose it
}
...
// ...interface{} in the method signature. This allows us to pass in multiple arguments to the method.
